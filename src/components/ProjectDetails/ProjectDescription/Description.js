...
import PrivateBanner from "../../../assets/img/syncera-ido.png";
              ...
              <div>
                <div>
                  ...
                  <span className="block w-full text-sm text-paragraph-text mb-5 leading-[26px] project-content">
                    ...
                    ecosystem by providing an all-in-one DeFi platform that will
                    accommodate projects and new investors entering the space
                    for the first time.
                  </span>
                  <div
                    id="content-about"
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 mb-30px last:mb-0">
                      ...
                      <p className="text-paragraph-text text-sm leading-[26px] mb-2 last:mb-0 project-content">
                        ...
                        decentralized finances. The project's vision is to
                        create a strong DeFi community on zkSync and other
                        chains, offering a go-to launchpad for hot projects
                        while rewarding its holders. The platform will offer
              ...
              <div>
                <div className="flex justify-center items-center flex-col">
                  ...
                  <span className="block w-full text-sm text-paragraph-text mb-5 leading-[26px] whitelist-instructions">
                    ...
                    Zealy, you can <i>increase</i> your allocation by continuing
                    to level up and claim higher Discord roles.
                  </span>
                  <span className="block w-full text-sm text-paragraph-text mb-5 leading-[26px] whitelist-instructions">
                    The deadline for claiming your whitelist position will be
                    announced in advance. Prior to the sale, you can connect
                    your wallet and confirm your eligibility for the IDO.
                  </span>
                  <div className="w-60">
                    <a
