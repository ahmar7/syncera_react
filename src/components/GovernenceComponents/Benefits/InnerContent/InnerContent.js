...
import Planet from "../../../../assets/img/palnnet.png";
const InnnerContent = () => {
  return (
          ...
          <div className="css-10pdk1q">
            ...
            <div className="css-18owyug">
              ...
              <div className="css-3hdxq3">
                <div data-bn-type="text" className="css-1v7bny7">
                  UP to 16.30% APY
                </div>
            ...
            <div data-bn-type="text" className="css-p6bfns">
              Get community governance voting rights, Participate in important
              decision-making for ApolloX.
            </div>
          </div>
            ...
            <div className="css-1j8ayyd">
              ...
              <div className="css-uliqdc">
                <div className="css-130o8im">
                  ...
                  <div className="css-3hdxq3">
                    <div data-bn-type="text" className="css-iewdk7">
                      350K APX
                    </div>
                    <div className="css-m5gimw">
                      <div
                        ...
                        data-popper-placement="top"
                      >
                        Rewards will be calculated over 7 days for each
                        cycle，Can be claimed rewards on 2023/04/20.
                        <i className="gap-fill" />
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div data-bn-type="text" className="css-p6bfns">
                  ApolloX will inject a certain amount into the DAO reward pool
                  every cycle (7 days) to reward all VeNFT holders. The amount
                  is accumulated over the cycle and calculated based on Power
                  weightage.
                </div>
              </div>
            </div>
            <div className="css-883xeg">
              ...
              <div className="css-uliqdc">
                <div className="css-1hzvpag">
                  ...
                  >
                    <div className="css-4cffwv">
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        className="out-link-svg css-n7tore"
                      >
                        <path
                  ...
                  <div data-bn-type="text" className="css-16p0xkh">
                    -{/* */}&nbsp;/&nbsp;{/* */}13.69M APX
                  </div>
                  <div data-bn-type="text" className="css-179ahrg">
                    Today Repurchase / Cumulative
                  </div>
                </div>
                <div data-bn-type="text" className="css-p6bfns">
                  ApolloX will set aside a portion of trading fee income every
                  day, used to repurchase APX from the secondary market from
                  time to time. The repurchased APX will be added into the DAO
                  reward pool.
                </div>
              </div>
            </div>
      ...
      <div className="governance-landing-benefits-list css-egt1ma">
        ...
        <div className="css-1v6yiiv">
          <div className="css-10pdk1q">
            ...
            <div data-bn-type="text" className="css-p6bfns">
              Accelerate trading rewards tier, Higher tiers mean higher
              transaction rewards.
            </div>
          </div>
          <div className="css-ggvcnp">
            <div className="css-1j8ayyd">
              ...
              <div className="css-uliqdc">
                <div className="css-130o8im">
                  ...
                  <div data-bn-type="text" className="css-k60thd">
                    0.00 APX
                  </div>
                  <a
                    data-bn-type="link"
                    ...
                    target="_blank"
                  >
                    <div className="css-12aqrg4">
                      <div data-bn-type="text" className="css-1nkqv4g">
                        Claim your rewards
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                        className="out-link-svg css-1rjnhs8"
                      >
